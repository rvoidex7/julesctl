...
pub fn manager_bootstrap_prompt(user_goal: &str, task_file_path: &str) -> String {
    format!(
...
Start now: write {task_file_path} with your task breakdown, then send open_session messages for all tasks that have no dependencies."#,
